...
Uses correct paths for your extracted sequences
"""
...
# CORRECT PATH: Your files are in /Users/labibatasnim/PycharmProjects/HelloWorld/extracted_coi_regions/
...
def find_best_protein(dna_seq):
    """
    Find the best protein translation by trying all 6 reading frames.
    """
    ...
    # Try reverse complement (3 frames)
...
for i, record in enumerate(records, 1):
    ...
    if protein and protein_len >= 100:  # Minimum 100 aa
        ...
        # Check if reasonable COI length
...
if translated_records:
    ...
    for record in records:
        ...
        # Try to translate from beginning
        try:
            # Make multiple of 3
